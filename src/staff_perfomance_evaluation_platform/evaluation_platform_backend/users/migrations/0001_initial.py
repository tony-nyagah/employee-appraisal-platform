    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pf_number', models.CharField(blank=True, max_length=20, null=True, unique=True, verbose_name='personnel file number')),
                ...
                ('role', models.CharField(choices=[('RS', 'Regular Staff'), ('MS', 'Managerial Staff'), ('BOM', 'Board of Management')], default='RS', max_length=5)),
